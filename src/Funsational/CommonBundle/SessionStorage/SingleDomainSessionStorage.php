...
/*
 * This file is part of the Funsational, Inc. package.
 *
...
namespace Funsational\CommonBundle\SessionStorage;
 ...
 */
class SingleDomainSessionStorage extends NativeSessionStorage
{
	public $em;

	public $container;

	public function __construct(array $options,  $em, $container)
	{
...
echo 's';
		var_dump($container->get('request')->getSession());
	}
